...
RELEVANCE_MODEL = os.environ.get("RELEVANCE_MODEL", "deepseek-r1:8b")
...
class LLMQueryEngine:
    ...
    def __init__(self,
                 ...
                 relevance_generation_model: str = RELEVANCE_MODEL):
...
#         Uses a hybrid retrieval that merges dense (vector) and BM25 (sparse) results.
#         """
