...
def visualize_with_pyvis(graph, output_filename="graph.html"):
    ...
    for node, data in graph.nodes(data=True):
        ...
        # Extract node name from hash prefix.
        node_name = str(node)
        parts = node_name.split("_", 1)  # Split at the first underscore
        node_name = parts[-1]
...
def process_ontology():
    ...
    ontology_file = "tests/papers_rag/annett-o-test.owl"
    ...
    output_path = "tests/papers_rag/instance_graph.html"
