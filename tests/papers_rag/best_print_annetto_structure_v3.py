...
# from utils.constants import Constants as C
# from utils.owl_utils import (
#     get_class_data_properties, get_connected_classes, get_subclasses, get_class_parents
#     )
...
#         processed_classes.add(cls)
#         final_marker = " [FIR]" if requires_final_instantiation(cls) else ""
#         final_marker += "<IS>" if subclasses_requires_final_instantiation(cls) else ""
...
#         final_marker = " [FIR]" if requires_final_instantiation(subclass) else ""
#         final_marker += "<IS>" if subclasses_requires_final_instantiation(subclass) else ""
